let path,getWorkingDir,getRepositoryRoot,bailFile;_a33‍.x([["normalizePath",()=>normalizePath],["getDependentStoryFiles",()=>getDependentStoryFiles]]);_a33‍.w("path",[["default",["path"],function(v){path=v}]]);_a33‍.w("./utils",[["getWorkingDir",["getWorkingDir"],function(v){getWorkingDir=v}]]);_a33‍.w("../git/git",[["getRepositoryRoot",["getRepositoryRoot"],function(v){getRepositoryRoot=v}]]);_a33‍.w("../ui/messages/warnings/bailFile",[["default",["bailFile"],function(v){bailFile=v}]]);
 ...
 */
       function normalizePath(posixPath, rootPath, workingDir = '') {
 ...
 */
       async function getDependentStoryFiles(ctx, stats, changedFiles) {
