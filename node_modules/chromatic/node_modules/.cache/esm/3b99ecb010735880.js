let chalk,pluralize;_107‍.x([["createTask",()=>createTask],["setTitle",()=>setTitle],["setOutput",()=>setOutput],["transitionTo",()=>transitionTo],["getDuration",()=>getDuration]]);_107‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_107‍.w("pluralize",[["default",["pluralize"],function(v){pluralize=v}]]);


       const createTask = ({ steps, ...config }) => ({
  ...config,
  task: async (ctx, task) => {
    ...
    for (const step of steps) {
      ...
      await step(ctx, task);
       ...
       const setTitle = (title, subtitle) => (ctx, task) => {
