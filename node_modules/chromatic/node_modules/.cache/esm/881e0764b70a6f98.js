let chalk,dedent,icon,link;_b70‍.x([["default",()=>fetchError]]);_b70‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_b70‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_b70‍.w("../../components/icons",[["error",["icon"],function(v){icon=v}]]);_b70‍.w("../../components/link",[["default",["link"],function(v){link=v}]]);
...
const lcfirst = (str) => `${str.charAt(0).toLowerCase()}${str.substr(1)}`;
               ...
               function fetchError({ title }, { error, response, statusCode } = {}) {
