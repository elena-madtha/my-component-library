let path,execa,gql,EOL,gitNoCommits,gitNotInitialized,gitNotInstalled;_cca‍.x([["FETCH_N_INITIAL_BUILD_COMMITS",()=>FETCH_N_INITIAL_BUILD_COMMITS],["getVersion",()=>getVersion],["getSlug",()=>getSlug],["getCommit",()=>getCommit],["getBranch",()=>getBranch],["hasPreviousCommit",()=>hasPreviousCommit],["getParentCommits",()=>getParentCommits],["getBaselineBuilds",()=>getBaselineBuilds],["getChangedFiles",()=>getChangedFiles],["isUpToDate",()=>isUpToDate],["isClean",()=>isClean],["getUpdateMessage",()=>getUpdateMessage],["findMergeBase",()=>findMergeBase],["checkout",()=>checkout],["checkoutPrevious",()=>checkoutPrevious],["discardChanges",()=>discardChanges],["getRepositoryRoot",()=>getRepositoryRoot]]);_cca‍.w("path",[["default",["path"],function(v){path=v}]]);_cca‍.w("execa",[["default",["execa"],function(v){execa=v}]]);_cca‍.w("fake-tag",[["default",["gql"],function(v){gql=v}]]);_cca‍.w("os",[["EOL",["EOL"],function(v){EOL=v}]]);_cca‍.w("../ui/messages/errors/gitNoCommits",[["default",["gitNoCommits"],function(v){gitNoCommits=v}]]);_cca‍.w("../ui/messages/errors/gitNotInitialized",[["default",["gitNotInitialized"],function(v){gitNotInitialized=v}]]);_cca‍.w("../ui/messages/errors/gitNotInstalled",[["default",["gitNotInstalled"],function(v){gitNotInstalled=v}]]);
...
async function execGitCommand(command) {
  try {
    ...
    throw error;
       ...
       const FETCH_N_INITIAL_BUILD_COMMITS = 20;
