let path,parse,duplicatePatchBuild,incompatibleOptions,invalidExitOnceUploaded,invalidOnly,invalidOnlyChanged,invalidPatchBuild,invalidReportPath,invalidSingularOptions,missingBuildScriptName,missingProjectToken,missingScriptName,missingStorybookPort,unknownStorybookPort,inferredOptions,getStorybookConfiguration;_586‍.x([["default",()=>getOptions]]);_586‍.w("path",[["default",["path"],function(v){path=v}]]);_586‍.w("url",[["parse",["parse"],function(v){parse=v}]]);_586‍.w("../ui/messages/errors/duplicatePatchBuild",[["default",["duplicatePatchBuild"],function(v){duplicatePatchBuild=v}]]);_586‍.w("../ui/messages/errors/incompatibleOptions",[["default",["incompatibleOptions"],function(v){incompatibleOptions=v}]]);_586‍.w("../ui/messages/errors/invalidExitOnceUploaded",[["default",["invalidExitOnceUploaded"],function(v){invalidExitOnceUploaded=v}]]);_586‍.w("../ui/messages/errors/invalidOnly",[["default",["invalidOnly"],function(v){invalidOnly=v}]]);_586‍.w("../ui/messages/errors/invalidOnlyChanged",[["default",["invalidOnlyChanged"],function(v){invalidOnlyChanged=v}]]);_586‍.w("../ui/messages/errors/invalidPatchBuild",[["default",["invalidPatchBuild"],function(v){invalidPatchBuild=v}]]);_586‍.w("../ui/messages/errors/invalidReportPath",[["default",["invalidReportPath"],function(v){invalidReportPath=v}]]);_586‍.w("../ui/messages/errors/invalidSingularOptions",[["default",["invalidSingularOptions"],function(v){invalidSingularOptions=v}]]);_586‍.w("../ui/messages/errors/missingBuildScriptName",[["default",["missingBuildScriptName"],function(v){missingBuildScriptName=v}]]);_586‍.w("../ui/messages/errors/missingProjectToken",[["default",["missingProjectToken"],function(v){missingProjectToken=v}]]);_586‍.w("../ui/messages/errors/missingScriptName",[["default",["missingScriptName"],function(v){missingScriptName=v}]]);_586‍.w("../ui/messages/errors/missingStorybookPort",[["default",["missingStorybookPort"],function(v){missingStorybookPort=v}]]);_586‍.w("../ui/messages/errors/unknownStorybookPort",[["default",["unknownStorybookPort"],function(v){unknownStorybookPort=v}]]);_586‍.w("../ui/messages/info/inferredOptions",[["default",["inferredOptions"],function(v){inferredOptions=v}]]);_586‍.w("./getStorybookConfiguration",[["default",["getStorybookConfiguration"],function(v){getStorybookConfiguration=v}]]);
...
const trueIfSet = (value) => (value === '' ? true : value);
               ...
               async function getOptions({ argv, env, flags, log, packageJson }) {
