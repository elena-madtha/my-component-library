let debug,createClient,stripAnsi,format,errorSerializer;_29d‍.x([["createLogger",()=>createLogger]]);_29d‍.w("debug",[["default",["debug"],function(v){debug=v}]]);_29d‍.w("node-loggly-bulk/lib/loggly/client",[["createClient",["createClient"],function(v){createClient=v}]]);_29d‍.w("strip-ansi",[["default",["stripAnsi"],function(v){stripAnsi=v}]]);_29d‍.w("util",[["format",["format"],function(v){format=v}]]);_29d‍.w("./logSerializers",[["errorSerializer",["errorSerializer"],function(v){errorSerializer=v}]]);/* eslint-disable no-console */
...
const handleRejection = (reason) => _29d‍.g.console.error('Unhandled promise rejection:', reason);
...
const logVerbose = (type, args) => {
  ...
  const log =
    ...
    (...args) => {
      ...
      else _29d‍.g.console[type](...messages);
