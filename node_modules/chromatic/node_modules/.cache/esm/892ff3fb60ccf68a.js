let envCi,forksUnsupported,gitOneCommit,missingGitHubInfo,missingTravisInfo,travisInternalBuild,getBranch,getCommit,hasPreviousCommit;_60c‍.x([["getCommitAndBranch",()=>getCommitAndBranch]]);_60c‍.w("env-ci",[["default",["envCi"],function(v){envCi=v}]]);_60c‍.w("../ui/messages/errors/forksUnsupported",[["default",["forksUnsupported"],function(v){forksUnsupported=v}]]);_60c‍.w("../ui/messages/errors/gitOneCommit",[["default",["gitOneCommit"],function(v){gitOneCommit=v}]]);_60c‍.w("../ui/messages/errors/missingGitHubInfo",[["default",["missingGitHubInfo"],function(v){missingGitHubInfo=v}]]);_60c‍.w("../ui/messages/errors/missingTravisInfo",[["default",["missingTravisInfo"],function(v){missingTravisInfo=v}]]);_60c‍.w("../ui/messages/warnings/travisInternalBuild",[["default",["travisInternalBuild"],function(v){travisInternalBuild=v}]]);_60c‍.w("./git",[["getBranch",["getBranch"],function(v){getBranch=v}],["getCommit",["getCommit"],function(v){getCommit=v}],["hasPreviousCommit",["hasPreviousCommit"],function(v){hasPreviousCommit=v}]]);
