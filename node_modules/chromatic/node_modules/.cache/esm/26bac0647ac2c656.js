let chalk,pluralize,stripAnsi,dedent,link;_7ac‍.x([["default",()=>fatalError]]);_7ac‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_7ac‍.w("pluralize",[["default",["pluralize"],function(v){pluralize=v}]]);_7ac‍.w("strip-ansi",[["default",["stripAnsi"],function(v){stripAnsi=v}]]);_7ac‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_7ac‍.w("../../components/link",[["default",["link"],function(v){link=v}]]);
...
const buildFields = ({ id, number, webUrl }) => ({ id, number, webUrl });
               ...
               function fatalError(ctx, error, timestamp = new Date().toISOString()) {
