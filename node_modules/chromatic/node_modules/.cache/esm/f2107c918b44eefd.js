let execa,fs,path,semver,tmp,createTask,transitionTo,buildFailed,failed,initial,pending,skipped,success;_8b4‍.x([["setSourceDir",()=>setSourceDir],["setSpawnParams",()=>setSpawnParams],["buildStorybook",()=>buildStorybook],["default",()=>_8b4‍.o]]);_8b4‍.w("execa",[["default",["execa"],function(v){execa=v}]]);_8b4‍.w("fs-extra",[["default",["fs"],function(v){fs=v}]]);_8b4‍.w("path",[["default",["path"],function(v){path=v}]]);_8b4‍.w("semver",[["default",["semver"],function(v){semver=v}]]);_8b4‍.w("tmp-promise",[["default",["tmp"],function(v){tmp=v}]]);_8b4‍.w("../lib/tasks",[["createTask",["createTask"],function(v){createTask=v}],["transitionTo",["transitionTo"],function(v){transitionTo=v}]]);_8b4‍.w("../ui/messages/errors/buildFailed",[["default",["buildFailed"],function(v){buildFailed=v}]]);_8b4‍.w("../ui/tasks/build",[["failed",["failed"],function(v){failed=v}],["initial",["initial"],function(v){initial=v}],["pending",["pending"],function(v){pending=v}],["skipped",["skipped"],function(v){skipped=v}],["success",["success"],function(v){success=v}]]);
...
const trimOutput = ({ stdout }) => stdout && stdout.toString().trim();
  ...
  if (ctx.options.outputDir) {
    ...
    ctx.sourceDir = tmpDir.path;
       ...
       const setSpawnParams = async (ctx) => {
